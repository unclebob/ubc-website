...
cljs.spec.alpha.def_impl.call(null,new cljs.core.Keyword("spacewar.game-logic.clouds","cloud","spacewar.game-logic.clouds/cloud",2018989582),cljs.core.list(new cljs.core.Symbol("cljs.spec.alpha","keys","cljs.spec.alpha/keys",1109346032,null),new cljs.core.Keyword(null,"req-un","req-un",1074571008),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("spacewar.game-logic.clouds","x","spacewar.game-logic.clouds/x",1606590526),new cljs.core.Keyword("spacewar.game-logic.clouds","y","spacewar.game-logic.clouds/y",1775768541),new cljs.core.Keyword("spacewar.game-logic.clouds","concentration","spacewar.game-logic.clouds/concentration",1835495341)], null)),cljs.spec.alpha.map_spec_impl.call(null,cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"req-un","req-un",1074571008),new cljs.core.Keyword(null,"opt-un","opt-un",883442496),new cljs.core.Keyword(null,"gfn","gfn",791517474),new cljs.core.Keyword(null,"pred-exprs","pred-exprs",1792271395),new cljs.core.Keyword(null,"keys-pred","keys-pred",858984739),new cljs.core.Keyword(null,"opt-keys","opt-keys",1262688261),new cljs.core.Keyword(null,"req-specs","req-specs",553962313),new cljs.core.Keyword(null,"req","req",-326448303),new cljs.core.Keyword(null,"req-keys","req-keys",514319221),new cljs.core.Keyword(null,"opt-specs","opt-specs",-384905450),new cljs.core.Keyword(null,"pred-forms","pred-forms",172611832),new cljs.core.Keyword(null,"opt","opt",-794706369)],[new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("spacewar.game-logic.clouds","x","spacewar.game-logic.clouds/x",1606590526),new cljs.core.Keyword("spacewar.game-logic.clouds","y","spacewar.game-logic.clouds/y",1775768541),new cljs.core.Keyword("spacewar.game-logic.clouds","concentration","spacewar.game-logic.clouds/concentration",1835495341)], null),null,null,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (G__1431){
return cljs.core.map_QMARK_.call(null,G__1431);
}),(function (G__1431){
return cljs.core.contains_QMARK_.call(null,G__1431,new cljs.core.Keyword(null,"x","x",2099068185));
}),(function (G__1431){
return cljs.core.contains_QMARK_.call(null,G__1431,new cljs.core.Keyword(null,"y","y",-1757859776));
}),(function (G__1431){
return cljs.core.contains_QMARK_.call(null,G__1431,new cljs.core.Keyword(null,"concentration","concentration",1539606986));
})], null),(function (G__1431){
return ((cljs.core.map_QMARK_.call(null,G__1431)) && (((cljs.core.contains_QMARK_.call(null,G__1431,new cljs.core.Keyword(null,"x","x",2099068185))) && (((cljs.core.contains_QMARK_.call(null,G__1431,new cljs.core.Keyword(null,"y","y",-1757859776))) && (cljs.core.contains_QMARK_.call(null,G__1431,new cljs.core.Keyword(null,"concentration","concentration",1539606986))))))));
...
cljs.spec.alpha.def_impl.call(null,new cljs.core.Keyword("spacewar.game-logic.clouds","clouds","spacewar.game-logic.clouds/clouds",-924713794),cljs.core.list(new cljs.core.Symbol("cljs.spec.alpha","coll-of","cljs.spec.alpha/coll-of",1019430407,null),new cljs.core.Keyword("spacewar.game-logic.clouds","cloud","spacewar.game-logic.clouds/cloud",2018989582)),cljs.spec.alpha.every_impl.call(null,new cljs.core.Keyword("spacewar.game-logic.clouds","cloud","spacewar.game-logic.clouds/cloud",2018989582),new cljs.core.Keyword("spacewar.game-logic.clouds","cloud","spacewar.game-logic.clouds/cloud",2018989582),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword("cljs.spec.alpha","conform-all","cljs.spec.alpha/conform-all",45201917),true,new cljs.core.Keyword("cljs.spec.alpha","kind-form","cljs.spec.alpha/kind-form",-1047104697),null,new cljs.core.Keyword("cljs.spec.alpha","describe","cljs.spec.alpha/describe",1883026911),cljs.core.list(new cljs.core.Symbol("cljs.spec.alpha","coll-of","cljs.spec.alpha/coll-of",1019430407,null),new cljs.core.Keyword("spacewar.game-logic.clouds","cloud","spacewar.game-logic.clouds/cloud",2018989582)),new cljs.core.Keyword("cljs.spec.alpha","cpred","cljs.spec.alpha/cpred",-693471218),(function (G__1432){
return cljs.core.coll_QMARK_.call(null,G__1432);
})], null),null));
...
var clouds = cljs.core.get.call(null,map__1436__$1,new cljs.core.Keyword(null,"clouds","clouds",-632461223));
var ship = cljs.core.get.call(null,map__1436__$1,new cljs.core.Keyword(null,"ship","ship",197863473));
...
var vec__1440 = spacewar.game_logic.clouds.harvest_dilithium.call(null,ms,ship__$1,cljs.core.first.call(null,clouds__$1));
var ship__$2 = cljs.core.nth.call(null,vec__1440,(0),null);
var cloud = cljs.core.nth.call(null,vec__1440,(1),null);
var G__1443 = cljs.core.rest.call(null,clouds__$1);
var G__1444 = ship__$2;
var G__1445 = cljs.core.conj.call(null,harvested_clouds,cloud);
clouds__$1 = G__1443;
ship__$1 = G__1444;
harvested_clouds = G__1445;
continue;
}
break;
}
...
var clouds__$1 = cljs.core.map.call(null,(function (p1__1446_SHARP_){
return cljs.core.update.call(null,p1__1446_SHARP_,new cljs.core.Keyword(null,"concentration","concentration",1539606986),cljs.core._STAR_,decay);
}),clouds);
var clouds__$2 = cljs.core.filter.call(null,(function (p1__1447_SHARP_){
return (new cljs.core.Keyword(null,"concentration","concentration",1539606986).cljs$core$IFn$_invoke$arity$1(p1__1447_SHARP_) > (1));
}),clouds__$1);
