...
var map__613 = state;
var map__613__$1 = cljs.core.__destructure_map.call(null,map__613);
var w = cljs.core.get.call(null,map__613__$1,new cljs.core.Keyword(null,"w","w",354169001));
var h = cljs.core.get.call(null,map__613__$1,new cljs.core.Keyword(null,"h","h",1109658740));
var color = cljs.core.get.call(null,map__613__$1,new cljs.core.Keyword(null,"color","color",1011675173));
var mouse_in = cljs.core.get.call(null,map__613__$1,new cljs.core.Keyword(null,"mouse-in","mouse-in",-744173595));
...
spacewar.ui.widgets.slider.draw_slider_thumb = (function spacewar$ui$widgets$slider$draw_slider_thumb(p__614){
var map__615 = p__614;
var map__615__$1 = cljs.core.__destructure_map.call(null,map__615);
var stroke = cljs.core.get.call(null,map__615__$1,new cljs.core.Keyword(null,"stroke","stroke",1741823555));
var thumb_color = cljs.core.get.call(null,map__615__$1,new cljs.core.Keyword(null,"thumb-color","thumb-color",2069729567));
var thumb_x = cljs.core.get.call(null,map__615__$1,new cljs.core.Keyword(null,"thumb-x","thumb-x",1377869681));
var thumb_y = cljs.core.get.call(null,map__615__$1,new cljs.core.Keyword(null,"thumb-y","thumb-y",-1319695779));
var w = cljs.core.get.call(null,map__615__$1,new cljs.core.Keyword(null,"w","w",354169001));
var thumb_h = cljs.core.get.call(null,map__615__$1,new cljs.core.Keyword(null,"thumb-h","thumb-h",-1854577768));
var value = cljs.core.get.call(null,map__615__$1,new cljs.core.Keyword(null,"value","value",305978217));
...
var map__616 = state;
var map__616__$1 = cljs.core.__destructure_map.call(null,map__616);
var y = cljs.core.get.call(null,map__616__$1,new cljs.core.Keyword(null,"y","y",-1757859776));
var min_val = cljs.core.get.call(null,map__616__$1,new cljs.core.Keyword(null,"min-val","min-val",-243137826));
var max_val = cljs.core.get.call(null,map__616__$1,new cljs.core.Keyword(null,"max-val","max-val",-1492247884));
var mouse_pos = cljs.core.get.call(null,map__616__$1,new cljs.core.Keyword(null,"mouse-pos","mouse-pos",370762057));
var margin = cljs.core.get.call(null,map__616__$1,new cljs.core.Keyword(null,"margin","margin",-995903681));
var range = cljs.core.get.call(null,map__616__$1,new cljs.core.Keyword(null,"range","range",1639692286));
var increment = cljs.core.get.call(null,map__616__$1,new cljs.core.Keyword(null,"increment","increment",-1558831484));
var vec__617 = mouse_pos;
var _ = cljs.core.nth.call(null,vec__617,(0),null);
var my = cljs.core.nth.call(null,vec__617,(1),null);
...
var map__620 = state;
var map__620__$1 = cljs.core.__destructure_map.call(null,map__620);
var min_val = cljs.core.get.call(null,map__620__$1,new cljs.core.Keyword(null,"min-val","min-val",-243137826));
var max_val = cljs.core.get.call(null,map__620__$1,new cljs.core.Keyword(null,"max-val","max-val",-1492247884));
var thumb_x = cljs.core.get.call(null,map__620__$1,new cljs.core.Keyword(null,"thumb-x","thumb-x",1377869681));
var min_y = cljs.core.get.call(null,map__620__$1,new cljs.core.Keyword(null,"min-y","min-y",-1969872948));
var max_y = cljs.core.get.call(null,map__620__$1,new cljs.core.Keyword(null,"max-y","max-y",1525628082));
cljs.core.apply.call(null,quil.core.fill,spacewar.ui.config.black);
...
var w = cljs.core.get.call(null,map__621__$1,new cljs.core.Keyword(null,"w","w",354169001));
var h = cljs.core.get.call(null,map__621__$1,new cljs.core.Keyword(null,"h","h",1109658740));
var min_val = cljs.core.get.call(null,map__621__$1,new cljs.core.Keyword(null,"min-val","min-val",-243137826));
var max_val = cljs.core.get.call(null,map__621__$1,new cljs.core.Keyword(null,"max-val","max-val",-1492247884));
...
var self__ = this;
var ___$1 = this;
var map__622 = self__.state;
var map__622__$1 = cljs.core.__destructure_map.call(null,map__622);
var x = cljs.core.get.call(null,map__622__$1,new cljs.core.Keyword(null,"x","x",2099068185));
var margin = cljs.core.get.call(null,map__622__$1,new cljs.core.Keyword(null,"margin","margin",-995903681));
var thumb_color = cljs.core.get.call(null,map__622__$1,new cljs.core.Keyword(null,"thumb-color","thumb-color",2069729567));
var y = cljs.core.get.call(null,map__622__$1,new cljs.core.Keyword(null,"y","y",-1757859776));
var increment = cljs.core.get.call(null,map__622__$1,new cljs.core.Keyword(null,"increment","increment",-1558831484));
var mouse_in = cljs.core.get.call(null,map__622__$1,new cljs.core.Keyword(null,"mouse-in","mouse-in",-744173595));
var disabled = cljs.core.get.call(null,map__622__$1,new cljs.core.Keyword(null,"disabled","disabled",-1529784218));
var left_down = cljs.core.get.call(null,map__622__$1,new cljs.core.Keyword(null,"left-down","left-down",2050158249));
var value = cljs.core.get.call(null,map__622__$1,new cljs.core.Keyword(null,"value","value",305978217));
var w = cljs.core.get.call(null,map__622__$1,new cljs.core.Keyword(null,"w","w",354169001));
var thumb_x = cljs.core.get.call(null,map__622__$1,new cljs.core.Keyword(null,"thumb-x","thumb-x",1377869681));
var max_val = cljs.core.get.call(null,map__622__$1,new cljs.core.Keyword(null,"max-val","max-val",-1492247884));
var thumb_h = cljs.core.get.call(null,map__622__$1,new cljs.core.Keyword(null,"thumb-h","thumb-h",-1854577768));
...
var w = cljs.core.get.call(null,map__623__$1,new cljs.core.Keyword(null,"w","w",354169001));
var h = cljs.core.get.call(null,map__623__$1,new cljs.core.Keyword(null,"h","h",1109658740));
