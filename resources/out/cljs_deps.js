...
goog.addDependency("../spacewar/ui/messages.js", ['spacewar.ui.messages'], ['spacewar.game_logic.config', 'spacewar.ui.view_frame', 'cljs.core']);
goog.addDependency("../spacewar/game_logic/bases.js", ['spacewar.game_logic.bases'], ['cljs.spec.alpha', 'spacewar.game_logic.config', 'spacewar.game_logic.explosions', 'spacewar.ui.messages', 'spacewar.geometry', 'spacewar.util', 'spacewar.vector', 'cljs.core']);
goog.addDependency("../spacewar/game_logic/ship.js", ['spacewar.game_logic.ship'], ['clojure.set', 'cljs.spec.alpha', 'spacewar.game_logic.bases', 'spacewar.game_logic.config', 'spacewar.geometry', 'spacewar.ui.view_frame', 'spacewar.ui.messages', 'spacewar.util', 'spacewar.vector', 'cljs.core']);
goog.addDependency("../spacewar/ui/control_panels/engine_panel.js", ['spacewar.ui.control_panels.engine_panel'], ['spacewar.ui.protocols', 'spacewar.ui.config', 'spacewar.ui.widgets.lcars', 'spacewar.ui.widgets.button', 'spacewar.ui.widgets.direction_selector', 'spacewar.ui.widgets.slider', 'spacewar.ui.widgets.engage', 'spacewar.geometry', 'spacewar.vector', 'spacewar.game_logic.ship', 'quil.core', 'cljs.core']);
...
goog.addDependency("../spacewar/ui/control_panels/deploy_panel.js", ['spacewar.ui.control_panels.deploy_panel'], ['spacewar.ui.protocols', 'spacewar.ui.config', 'spacewar.ui.widgets.lcars', 'spacewar.ui.widgets.button', 'spacewar.game_logic.ship', 'cljs.core']);
goog.addDependency("../spacewar/ui/complex.js", ['spacewar.ui.complex'], ['quil.core', 'spacewar.ui.protocols', 'spacewar.ui.view_frame', 'spacewar.ui.config', 'spacewar.ui.control_panels.scan_panel', 'spacewar.ui.control_panels.engine_panel', 'spacewar.ui.control_panels.weapons_panel', 'spacewar.ui.control_panels.damage_panel', 'spacewar.ui.control_panels.status_panel', 'spacewar.ui.control_panels.deploy_panel', 'spacewar.ui.widgets.lights', 'spacewar.ui.widgets.engage', 'cljs.core']);
...
goog.addDependency("../spacewar/game_logic/shots.js", ['spacewar.game_logic.shots'], ['spacewar.geometry', 'spacewar.vector', 'spacewar.game_logic.config', 'spacewar.game_logic.ship', 'spacewar.util', 'clojure.set', 'spacewar.game_logic.explosions', 'cljs.spec.alpha', 'quil.core', 'cljs.core']);
goog.addDependency("../spacewar/game_logic/klingons.js", ['spacewar.game_logic.klingons'], ['cljs.spec.alpha', 'quil.core', 'spacewar.game_logic.clouds', 'spacewar.game_logic.config', 'spacewar.game_logic.explosions', 'spacewar.game_logic.hit', 'spacewar.game_logic.shots', 'spacewar.geometry', 'spacewar.util', 'spacewar.vector', 'cljs.core']);
goog.addDependency("../spacewar/game_logic/romulans.js", ['spacewar.game_logic.romulans'], ['cljs.spec.alpha', 'spacewar.game_logic.config', 'spacewar.game_logic.explosions', 'spacewar.game_logic.shots', 'spacewar.ui.messages', 'spacewar.geometry', 'spacewar.vector', 'spacewar.util', 'cljs.core']);
